...
export abstract class SqrtPriceMath {
  ...
  public static getAmount1Delta (sqrtRatioAX96: JSBI, sqrtRatioBX96: JSBI, liquidity: JSBI, roundUp: boolean): JSBI {
    ...
    console.log('roundUp=', roundUp, 'liquidity=', liquidity, ';sqrtRatioBX96=', sqrtRatioBX96, ';sqrtRatioAX96=', sqrtRatioAX96, ';Q96=', Q96)
    console.log('JSBI.subtract(sqrtRatioBX96, sqrtRatioAX96)=', JSBI.subtract(JSBI.BigInt(5000), JSBI.BigInt(300)))
    return roundUp
      ? FullMath.mulDivRoundingUp(liquidity, JSBI.subtract(JSBI.BigInt(sqrtRatioBX96), JSBI.BigInt(sqrtRatioAX96)), Q96)
      : JSBI.divide(JSBI.multiply(liquidity, JSBI.subtract(JSBI.BigInt(sqrtRatioBX96), JSBI.BigInt(sqrtRatioAX96))), Q96)
  }
