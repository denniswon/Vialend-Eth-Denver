  ...
  <div id="setting_container" v-loading="loadTickerLoading">
    <div class="token_exchange_form">
      ...
      <el-tabs type="border-card">
        <el-tab-pane>
          <span slot="label">
            <svg-icon name="currencyconverter" width="1.3em" height="1.3em" />
            CurrencyConverter
          </span>
          <el-form :inline="true" class="demo-form-inline">
            <el-form-item>
              <el-input v-model="currTokenVal" placeholder="1"></el-input>
            </el-form-item>
            <el-form-item>
              <el-select v-model="currTokenId" placeholder="Please select" @change="exchangeTokenChange">
                <el-option v-for="item in tokensList" :key="item.nameid" :label="item.symbol" :value="item.symbol"></el-option>
              </el-select>
              =
            </el-form-item>
            <el-form-item>
        ...
        <el-tab-pane>
          <span slot="label">
            <svg-icon name="emergency" width="1.3em" height="1.3em" />
            Emergency
          </span>
          <div class="pairs-selector">
            <el-select v-model="pairSelectedIndex" placeholder="Please select pairs" v-if="pairsData.pairsList && pairsData.pairsList.size() > 0">
          ...
          <div class="clear"></div>
          <div class="stat-container" v-loading="statDataLoading"></div>
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
  ...
  async setStat() {
    ...
    if (factoryContract !== null) {
      ...
      factoryContract.methods
        .changeStat(this.currentPair.strategyAddress, this.currentPair.vaultAddress, this.stat)
        .send({
