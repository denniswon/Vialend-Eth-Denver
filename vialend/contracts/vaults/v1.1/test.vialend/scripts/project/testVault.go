...
func Deposit(do int, param [4]int64) {
...
func GetCapital(accId int) {
	...
	cap0, cap1, fees0, fees1, _ := vaultInstance.GetCapital(&bind.CallOpts{}, config.GetAddress(accId))

	fmt.Println("getcapital account", accId, ":  ", cap0, cap1, fees0, fees1)
...
func GetTVL() *struct {
	...
	//lendingAmt0, lendingAmt1 := GetLending()
...
// func GetLending() (*big.Int, *big.Int) {

// 	Instance := GetVaultInstance()

// 	//implement gettvl
// 	lastLending0, _ := Instance.LastLending0(&bind.CallOpts{})
// 	lastLending1, _ := Instance.LastLending1(&bind.CallOpts{})

// 	return lastLending0, lastLending1
...
func AccountInfo() {
	...
	ListAccounts, _ := vaultInstance.Accounts(&bind.CallOpts{}, big.NewInt(1))

	fmt.Println("stored address:", ListAccounts)
