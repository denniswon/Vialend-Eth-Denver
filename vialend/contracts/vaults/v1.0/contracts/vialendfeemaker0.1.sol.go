    ...
    ReentrancyGuard
{
  ...
  //       }
    ...
    function getLendingAmounts() public returns(uint256 amount0, uint256 amount1){

    	(uint256 camount0, uint256 camount1) = getCAmounts();
       
    // Amount of current exchange rate from cToken to underlying
        uint256 exchangeRate0 = CToken0.exchangeRateCurrent();
        uint256 exchangeRate1 = CToken1.exchangeRateCurrent();
        
        amount0 = camount0.mul(exchangeRate0);
        amount1 = camount1.mul(exchangeRate1);
