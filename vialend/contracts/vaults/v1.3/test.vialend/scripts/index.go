...
func DeployVault() {
	...
	project.DeployVialendFeemaker(4, 1, big.NewInt(10), 100, "0xEa24c7256ab5c61b4dC1c5cB600A3D0bE826a440")
...
func DeployVaultBridge() {
	...
	//project.SetVaultAddress("0xA383011e531091FDB6caeEA3e3ed8ED0d8EdE371", 0)
